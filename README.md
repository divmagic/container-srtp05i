...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-srtp05i.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-srtp05i.containers.anotherwebservice.com/
...
```
git clone git@github.com:divmagic/container-srtp05i.git
cd container-srtp05i
```
...
```
docker attach container-srtp05i
```
